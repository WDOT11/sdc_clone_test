<template>
  <div class="home-content">
    ...
    <div class="head_dash_titile"><h6 class="my-0 themetextcolor"><b class="dashBold">Dashboard</b></h6></div>
    ...
    <div class="profile_col">
      ...
      <button data-bs-toggle="modal" data-bs-target="#coverage_check" class="btn check_coveragebtn bg_blue text-white"><div class="d-flex align-items-center maingape"><img width="25" height="25"  :src="$imagePath + 'verify.gif'">Verify Coverage</div></button>
      ...
      <div class="Adrop_outer">
        <div class="Adrop_box_wrap">
          ...
          <ul class="Adrop_list">
            <li>
              <a :href="$userAppUrl + 'smarttiusadmin/profile'">
  ...
  <!-- Coverage Model -->
  <admin-verify-coverage></admin-verify-coverage>
  <!-- Notification Side Bar  -->
  <admin-dash-notification v-if="notificationsVisible" :notificationsdata="notificationsData" :notificationsvisible="notificationsVisible" @close-notifications="notificationsVisible = false" />
</template>
...
export default {
  ...
  methods: {
    ...
    async notificationsCount() {
      try {
        const response = await axios.get(`${this.$userAppUrl}smarttiusadmin/get-notifications/count`);
    ...
    async loadNotifications() {
      try {
        ...
        show_ajax_loader();
        const response = await axios.get(`${this.$userAppUrl}smarttiusadmin/get-notifications`);
    ...
    confirmLogOut() {
      ...
      this.$deleteAlertMessage.data.callback = this.adminLogout;
    },
    async adminLogout() {
      try {
        const response = await axios.post(
          `${this.$userAppUrl}smarttiusadmin/logout`,
          {},
