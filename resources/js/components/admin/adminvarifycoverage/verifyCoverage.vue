        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content onewhitebg">
                ...
                <div class="modal-body onewhitebg">
                    <div class="form-group">
                        ...
                        <small v-if="validationErrors.name" >
                            <ErrorMessage :msg="validationErrors.name"></ErrorMessage></small>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="form-label mt-3">Serial Number/Asset Tag</label>
                ...
                <div class="modal-footer onewhitebg justify-content-start">
                    ...
                    <button type="button" @click="resetForm" class="btn customm_reset_btn themetextcolor">Reset</button>
                </div>
                <!-- Coverage Listing -->
    ...
    methods: {
        ...
        async getDeviceData() {
            ...
            try {
                ...
                let response = await axios.post(`${this.$userAppUrl}smarttiusadmin/verify-coverage`,{
                    name: this.name,
