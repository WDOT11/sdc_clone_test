<template>
    <div class="container-fluid ">
        <div class="card border-0 p-3 mt_12">
            <h4 class="coman_main_heading border-bottom pb-2">Edit Profile</h4>
            ...
            <div class="edit-user-form">
                ...
                <div class="flex justify-end mt-3">
                    <button @click="cancelUpdate" class="btn btn-secondary mr-2">
                        Cancel
                    </button>
...
export default {
    ...
    methods: {
        ...
        async getUserData() {
            show_ajax_loader();
            try {
                const response = await axios.get(`${this.$userAppUrl}sdcsmuser/profile/user-data`);
        ...
        async updateUser(e) {
            ...
            try {
                ...
                let response = await axios.post(`${this.$userAppUrl}sdcsmuser/profile/update/${this.editUserId}`, userData, { headers: { "Content-Type": "multipart/form-data" }, });
                ...
                if (response.data.success == true) {
                    ...
                    setTimeout(
                        () =>
                            (location.href = `${this.$userAppUrl}sdcsmuser/profile`),
                        2000
                    );
                }
            } catch (error) {
