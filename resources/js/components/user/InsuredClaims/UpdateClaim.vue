        ...
        <div class="card onewhitebg rounded border-0 ">
           <div class="card-body">
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a :href="$userAppUrl + 'sdcsmuser/user-track-claims'" class="btn btn-secondary me-2">Cancel</a>
...
export default {
    ...
    methods: {
        ...
        async getClaimReasonsbyDeviceID(device_id){
            ...
            try {
                let response = await axios.get(`${this.$userAppUrl}sdcsmuser/claim-reasons?deviceId=${device_id}`);
        ...
        async submitForm(){
            ...
            try {
                ...
                let response = await axios.post(`${this.$userAppUrl}sdcsmuser/update-claims-data`, {
                ...
                if (response.data.success == true) {
                    ...
                    setTimeout(() => (location.href = `${this.$userAppUrl}sdcsmuser/user-track-claims`),4000);
