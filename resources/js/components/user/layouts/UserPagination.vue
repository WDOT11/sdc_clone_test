<template>
    <nav class="pagination is-centered is-rounded" role="navigation" aria-label="pagination">
        <div class="onewhitebg flex items-center justify-between ">
            <div class=" ">
                <div>
                ...
                <div class="mt-2">
                    ...
                    <nav class="mainpagination" aria-label="Pagination">
                        ...
                        <a href="javascript.void(0)" @click.prevent="changePage(pagination.current_page < 2 ? pagination.current_page : pagination.current_page  - 1)" :disabled="pagination.current_page < 2" :class="(pagination.current_page < 2) ? 'cursor-not-allowed' : 'cursor-pointer' "  class="">
