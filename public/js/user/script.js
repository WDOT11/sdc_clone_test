...
function hide_user_popup(modalId) {
    jQuery(modalId).click();
}

/** Functions to show and hide the loader */
function show_ajax_loader() {
    jQuery("#user_ajax_loader").show();
}

function hide_ajax_loader() {
    jQuery("#user_ajax_loader").hide();
}

jQuery(document).ready(function () {
    const container = $("#user_sidebar_menu");
    ...
    //     }
    // });
    jQuery(".renowclose").click(function(){
        jQuery(".renewcard").hide();
    });
});
document.addEventListener("DOMContentLoaded", function () {
 jQuery(function () {
